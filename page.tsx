  ...
  return (
    <main className="p-6 max-w-5xl mx-auto space-y-12">
      <section className="text-center space-y-4">
        <h1 className="text-4xl font-bold">스터디 헬퍼</h1>
        <p className="text-lg text-muted-foreground">
          PPT 제작부터 보고서, 자료 찾기, 영상 편집까지 ONE STOP 대행 서비스
        </p>
        <div className="flex justify-center gap-4">
          <Button>
            <a href="https://instagram.com/wo.jn00" target="_blank" rel="noopener noreferrer">
              인스타 문의
            </a>
          </Button>
          <Button variant="outline">
            <a href="https://open.kakao.com/o/s500060009000" target="_blank" rel="noopener noreferrer">
              카카오톡 문의
            </a>
          </Button>
        </div>
